...
public class SokobanUI extends Pane {
    ...
    public void initSplashScreen() {
        ...
        for (int i = 0; i < levels.size(); i++) {
            ...
            levelImageView.setFitHeight(80.0);
            levelImageView.setFitWidth(80.0);
    ...
    //SokobanFileLoader fl2=new SokobanFileLoader();
    ...
    public void loadFile(String level){
       ...
       if(level.equals("Level 1"))
        ...
        if(level.equals("Level 7"))
            fl.openfile("Level 7");
        fl.gridRenderer.repaint();
    }
    
    
    public void initGameScreen(){
        gamePanel.setCenter(fl.gridRenderer);
    }
